      ...
      if (this.gameId != null) {
        ...
        .then((gameApiResult) => {
          ...
          if (gameApiResult.isPostseason == true) {
            ...
            gameTitleElem.innerHTML = "Klein Cup: " + gameApiResult.description + " <small>- S" + sp1 + "</small>";
          } else {
            var sp1 = gameApiResult.season + 1;
            var dp1 = gameApiResult.day + 1;
            var descr = "Klein Season " + sp1 + " Day " + dp1;
        ...
        .then((mapApiResult) => {
          ...
          // Set the game title
          var gameTitleElem = document.getElementById('golly-game-title');
          gameTitleElem.innerHTML = "Klein Map: " + mapApiResult.mapName;
        ...
        if ((this.s1user != null) || (this.s2user != null)) {
          ...
          // Set the game title
          var gameTitleElem = document.getElementById('golly-game-title');
          gameTitleElem.innerHTML = "Klein Sandbox";
